...
function Post({ included, addToFavorites, removeFromFavorites, post, loggedUser, deletePost, editPost }) {
  ...
  const renderFavoriteButton = () => {
    ...
    if (!included) {
        return <Button className="btn btn-secondary btn-lg fave-btn" onClick={(event) => addToFavorites(event, post)}>Add To Favorites</Button>
      } else {
        return <Button className="btn btn-light btn-lg fave-btn" onClick={(event) => removeFromFavorites(event, post)}>Remove From Favorites</Button>
      }
        ...
        <Card className="bg-dark text-white rounded" >
          ...
          (
            ...
            <div className="container">
              <Row>
              <Col>
              <Button onClick={toggleModal} className="btn btn-secondary btn-lg fave-btn" >
                Edit Post
              </Button>
              </Col>
              <Col>
              <Button onClick={(e) => deletePost(e, post.id)} className="btn btn-secondary btn-lg fave-btn">
                Delete Post
              </Button>
              </Col>
              </Row>
